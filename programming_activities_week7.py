...
# with open("/workspaces/DATA_3500_sandbox/Activity_7.1/color_file", "w") as file:
...
# with open("/workspaces/DATA_3500_sandbox/person-1.json", "r") as file:
#     person = json.load(file)
#     person["age"] += 1

# with open("/workspaces/DATA_3500_sandbox/person-1.json", "w") as file:
